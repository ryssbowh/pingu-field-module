...
class M2019_10_01_182836436202_InstallField extends Migration
{
    ...
    {
        Schema::create(
            'bundle_fields', function (Blueprint $table) {
                $table->increments('id');
                $table->string('name');
        ...
        Schema::create(
            'bundle_field_values', function (Blueprint $table) {
                $table->increments('id');
        ...
        Schema::create(
            'field_booleans', function (Blueprint $table) {
                $table->increments('id');
        ...
        Schema::create(
            'field_integers', function (Blueprint $table) {
                $table->increments('id');
                $table->string('default');
                $table->boolean('required');
        ...
        Schema::create(
            'field_floats', function (Blueprint $table) {
                $table->increments('id');
        ...
        Schema::create(
            'field_texts', function (Blueprint $table) {
                $table->increments('id');
                $table->string('default');
                $table->boolean('required');
        ...
        Schema::create(
            'field_urls', function (Blueprint $table) {
                $table->increments('id');
                $table->string('default');
                $table->boolean('required');
                $table->timestamps();
